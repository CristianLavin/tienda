...
@Component({
  selector: 'app-nordico',
  templateUrl: './nordico.page.html',
  styleUrls: ['./nordico.page.scss'],
})
export class NordicoPage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'Lt9ie7KEnFzY90L6L1Fz', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
