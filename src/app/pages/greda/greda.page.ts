...
@Component({
  selector: 'app-greda',
  templateUrl: './greda.page.html',
  styleUrls: ['./greda.page.scss'],
})
export class GredaPage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'NFzMbBlx5PRiOtw7j0s0', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
