...
@Component({
  selector: 'app-helecho',
  templateUrl: './helecho.page.html',
  styleUrls: ['./helecho.page.scss'],
})
export class HelechoPage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'mne9hIswzbvhWzTbATlg', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
