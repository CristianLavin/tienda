...
@Component({
  selector: 'app-ficus',
  templateUrl: './ficus.page.html',
  styleUrls: ['./ficus.page.scss'],
})
export class FicusPage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'ncapvNgTRl76nQiR0VjJ', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
