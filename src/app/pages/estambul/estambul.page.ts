...
@Component({
  selector: 'app-estambul',
  templateUrl: './estambul.page.html',
  styleUrls: ['./estambul.page.scss'],
})
export class EstambulPage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'pPrRMQClYezlnMU3T2Zd', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
