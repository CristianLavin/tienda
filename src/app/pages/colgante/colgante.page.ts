...
@Component({
  selector: 'app-colgante',
  templateUrl: './colgante.page.html',
  styleUrls: ['./colgante.page.scss'],
})
export class ColgantePage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'ORSOt3LmWDFLiSYpKyPO', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
