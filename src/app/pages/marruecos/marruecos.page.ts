...
@Component({
  ...
  templateUrl: './marruecos.page.html',
  styleUrls: ['./marruecos.page.scss'],
})
export class MarruecosPage {
  Nombre: string = '';
  Imagen: string = '';
  Precio: number = 0;
  Descripcion: string = '';
  ...
  carrito() {
    const producto: Producto = {
      id: 'cvAxMKms2dwsKWPoXQ1Q', // ID del producto, asegúrate de obtenerlo de alguna manera
      nombre: this.Nombre,
      precio: this.Precio,
